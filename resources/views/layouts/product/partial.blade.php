...
<div class="form-group {{ $errors->has('images') ? ' has-error' : '' }} col-lg-6 col-md-6 col-sm-12 my-5" style="order: 12;">
...
<div class="form-group {{ $errors->has('size_id') ? ' has-error' : '' }} col-lg-6 col-md-6 col-sm-12 my-3" style="order: 3;">
