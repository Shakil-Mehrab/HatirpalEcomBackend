...
<div class="form-group{{ $errors->has('thumbnail1') ? ' has-error' : '' }} col-lg-4 col-md-4 col-sm-12 my-3" style="order: 12;">
    ...
    @endif
    <img src="{{asset($data?$data->thumbnail1:'https://ui-avatars.com/api/?name=Hatirpal')}}" alt="" width="50px" class="mt-2">
</div>
<div class="form-group{{ $errors->has('thumbnail2') ? ' has-error' : '' }} col-lg-4 col-md-4 col-sm-12 my-3" style="order: 12;">
    ...
    @endif
    <img src="{{asset($data?$data->thumbnail2:'https://ui-avatars.com/api/?name=Hatirpal')}}" alt="" width="50px" class="mt-2">
</div>
<div class="form-group{{ $errors->has('thumbnail3') ? ' has-error' : '' }} col-lg-4 col-md-4 col-sm-12 my-3" style="order: 12;">
    ...
    @endif
    <img src="{{asset($data?$data->thumbnail3:'https://ui-avatars.com/api/?name=Hatirpal')}}" alt="" width="50px" class="mt-2">
</div>
<div class="form-group{{ $errors->has('thumbnail4') ? ' has-error' : '' }} col-lg-4 col-md-4 col-sm-12 my-3" style="order: 12;">
    ...
    @endif
    <img src="{{asset($data?$data->thumbnail4:'https://ui-avatars.com/api/?name=Hatirpal')}}" alt="" width="50px" class="mt-2">
</div>
